<!-- Agregar nuevo grupo -->
<div id="editGrupoMenu" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-sm">
   	<div class="modal-content">
      	<?php
	      echo validation_errors(); 
			$attributes = array( 'id' => 'edit_menu', 'role' => 'role' );
	   	echo form_open( 'master/menu_grupo_edit' , $attributes ); 
	   	?>
			  	<div class="modal-content">
